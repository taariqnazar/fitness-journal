...
export default function HabitCheckButton({ className = "" }: { className?: string }) {
  ...
  return (
    <motion.button
      ...
      className={`relative flex items-center justify-center gap-3 px-10 py-6 rounded-[2.2rem] font-black text-xs uppercase tracking-[0.2em] transition-colors shadow-xl active:scale-95 disabled:active:scale-100 ${isDoneToday
